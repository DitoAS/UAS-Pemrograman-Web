...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-12 mb-3">
            <a href="insert.php" class="btn btn-success"><i class="fa-solid fa-cart-plus"></i>
            </a>
        </div>
        <?php
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-danger"><?php echo $Harga; ?></p>
                </div>
                <div class="card-footer">
                    <div class="float-end">
                        <a class="btn btn-warning" href="edit.php?id=<?php echo $Id; ?>"><i
                                class="fa-solid fa-file-pen"></i></a>
                        <button class="btn btn-danger confirm" data-id="<?php echo $Id; ?>"
                            data-nama="<?php echo $Nama; ?>"><i class="fa-solid fa-dumpster"></i></button>
                    </div>
                </div>
            </div>
        </div>
